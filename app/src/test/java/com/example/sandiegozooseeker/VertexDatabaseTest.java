...
public class VertexDatabaseTest {
    ...
    public void testInsert() {
        ...
        Vertex v1 = new Vertex("rabbit habitat", null, Vertex.Kind.EXHIBIT,"Rabbits In the Wild", tag1, 31.2, 32.2);
        Vertex v2 = new Vertex("wolf habitat", null, Vertex.Kind.EXHIBIT,"Wolves", tag2, 30.0, 35.2);
    ...
    public void testGet() {
        ...
        Vertex insertedAnimal = new Vertex("rabbit habitat",null, Vertex.Kind.EXHIBIT,"Rabbits In the Wild", tags, 31.2, 32.2);
    ...
    public void testDelete() {
        List<String> tags = new ArrayList<>(Arrays.asList("rabbit","mammal"));
        Vertex vertex = new Vertex("rabbit habitat",null, Vertex.Kind.EXHIBIT,"Rabbits In the Wild", tags, 31.2, 32.2);
        dao.insert(vertex);
